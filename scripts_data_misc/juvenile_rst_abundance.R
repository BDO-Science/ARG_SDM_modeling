...
# ───────────────────────────────────────────────────────────────────────────────
raw_catch <- read.csv(
  here("scripts_data_misc", "juvenile_data", "Raw Catch - Chinook.csv"),
  stringsAsFactors = FALSE
)

trap_eff  <- read.csv(
  here("scripts_data_misc", "juvenile_data", "Trap Efficiency Summary.csv"),
  stringsAsFactors = FALSE
)

trap_ops  <- read.csv(
  here("scripts_data_misc", "juvenile_data", "Trap Operations.csv"),
  stringsAsFactors = FALSE
)

environmentals      <- read.csv(
  here("scripts_data_misc", "juvenile_data", "Environmentals.csv"),
  stringsAsFactors = FALSE
)
