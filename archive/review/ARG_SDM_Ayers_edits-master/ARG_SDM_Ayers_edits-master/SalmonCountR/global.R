...
df_all             <- readRDS(here("app_data", "df_all.rds"))
egg_summary        <- readRDS(here("app_data", "egg_summary.rds"))
surv_lookup_full   <- readRDS(here("app_data", "surv_lookup_full.rds"))
base_P_list        <- readRDS(here("app_data", "base_P_list.rds"))
#rear_surv_lookup <- readRDS(here("app_data", "rear_surv_lookup.rds"))

calib_results         <- readRDS(here("app_data","calib_results.rds"))
calib_pred_by_variant <- readRDS(here("app_data","calib_pred_by_variant.rds"))
...
spawn_dates_by_env <- readRDS(here("app_data","spawn_dates_by_env.rds"))

# legacy .rda data
load(here("app_data", "american_river_instream.rda"))
