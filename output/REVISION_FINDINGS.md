...
*Script:* `scripts_data_misc/tdm_weight_sensitivity.R`
...
*Source:* `scripts_data_misc/frontloading_cohort_decomposition.R` Part 5 →
...
*Script:* `scripts_data_misc/mcda.R` (bar labels added)
...
*Script:* `scripts_data_misc/elicitation_tables.R`
...
*Script:* `scripts_data_misc/figure3_tdm_curves.R`
...
*Script:* `scripts_data_misc/evpi.R` → `output/evpi.csv`
...
*Script:* `scripts_data_misc/frontloading_cohort_decomposition.R`
...
`scripts_data_misc/frontloading_cohort_decomposition.R` Part 1 →
